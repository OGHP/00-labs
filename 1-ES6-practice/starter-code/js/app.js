...
function displayPics(){
  ...
  // I think console.log(rando); threw an error because it was trying to be called outside of the place it was being used. It was being called with the function but the rando variable was actually being defined in the while loop.
  console.log(viewed)
